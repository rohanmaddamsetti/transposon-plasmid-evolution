...
##sbatch --mem=2G -c 1 --wrap="breseq -o ../results/genome-analysis/RM7-60-5 -r ../results/genome-analysis/RM6-176-18.gff3 ../data/genome-sequencing/MiGS_RohanMaddamsetti220509/RM7_60_5/*.fastq.gz"
...
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-5 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_5/*.fastq.gz"
...
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-9 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_9/*.fastq.gz"

## RM7.72.10-14 is B20 + A31 (Tet 50 populations).
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-10 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_10/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-11 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_11/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-12 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_12/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-13 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_13/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-14 -r ../results/genome-analysis/RM7-72-4.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_14/*.fastq.gz"

## RM7.72.15-19 is B30+noplasmid (Tet 0 control populations).
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-15 -r ../results/genome-analysis/RM6-200-6.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_15/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-16 -r ../results/genome-analysis/RM6-200-6.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_16/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-17 -r ../results/genome-analysis/RM6-200-6.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_17/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-18 -r ../results/genome-analysis/RM6-200-6.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_18/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-19 -r ../results/genome-analysis/RM6-200-6.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_19/*.fastq.gz"

## RM7.72.20-24 is B30+A18 (Tet 0 control populations).
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-20 -r ../results/genome-analysis/RM6-176-18.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_20/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-21 -r ../results/genome-analysis/RM6-176-18.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_21/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-22 -r ../results/genome-analysis/RM6-176-18.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_22/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-23 -r ../results/genome-analysis/RM6-176-18.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_23/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-24 -r ../results/genome-analysis/RM6-176-18.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_24/*.fastq.gz"

## RM7.72.25-29 is B20 + A18 (Tet 0 control populations).
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-25 -r ../results/genome-analysis/RM7-72-2.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_25/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-26 -r ../results/genome-analysis/RM7-72-2.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_26/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-27 -r ../results/genome-analysis/RM7-72-2.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_27/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-28 -r ../results/genome-analysis/RM7-72-2.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_28/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-29 -r ../results/genome-analysis/RM7-72-2.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_29/*.fastq.gz"
...
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-34 -r ../results/genome-analysis/RM7-72-3.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_34/*.fastq.gz"
...
##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-38 -r ../results/genome-analysis/RM7-72-1.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_38/*.fastq.gz"

##sbatch -p scavenger -t 16:00:00 --mem=8G -c 8 --wrap="breseq -j 8 -p --polymorphism-minimum-variant-coverage-each-strand 4 --base-quality-cutoff 10 -o ../results/genome-analysis/RM7-72-39 -r ../results/genome-analysis/RM7-72-1.gff3 ../data/genome-sequencing/SeqCenter_RohanMaddamsetti220702/RM7_72_39/*.fastq.gz"
